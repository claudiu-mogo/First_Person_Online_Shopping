...
print ('The first element of y is: ', c[0])
print ('The last element of y is: ', c[-1])
print ('The shape of X is: ' + str(X.shape))
print ('The shape of y is: ' + str(c.shape))
