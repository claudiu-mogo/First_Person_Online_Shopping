...
def loaddata():
    ...
    pret=np.asarray(pret)
    mat=np.asarray(matrice)
    matrice=np.asmatrix(mat)
    return matrice,vector,culori,size,pret

X, y, c, s, p = loaddata()
print ('The first element of X is: ', X[0])
print ('The first element of y is: ', p[0])
print ('The last element of y is: ', p[-1])
print ('The shape of X is: ' + str(X.shape))
print ('The shape of y is: ' + str(p.shape))
