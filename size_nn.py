...
print ('The first element of y is: ', s[0])
print ('The last element of y is: ', s[-1])
print ('The shape of X is: ' + str(X.shape))
print ('The shape of y is: ' + str(s.shape))
...
model.save('size.model')
arr = np.array([[0, 7, 1, 8, 4398.90]])
